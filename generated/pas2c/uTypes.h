...
typedef enum {sprWater = 0x0,
              ...
              sprPauseButton = 0x3b,
              sprTimerButton = 0x3c,
              sprTargetButton = 0x3d,
              sprSwitchButton = 0x3e,
              sprBounceButton = 0x3f,
              sprFlake = 0x40,
              sprHandRope = 0x41,
              sprHandBazooka = 0x42,
              sprHandShotgun = 0x43,
              sprHandDEagle = 0x44,
              sprHandAirAttack = 0x45,
              sprHandBaseball = 0x46,
              sprPHammer = 0x47,
              sprHandBlowTorch = 0x48,
              sprBlowTorch = 0x49,
              sprTeleport = 0x4a,
              sprHHDeath = 0x4b,
              sprShotgun = 0x4c,
              ...
              sprHandPlane = 0x69,
              sprUtility = 0x6a,
              sprInvulnerable = 0x6b,
              sprVampiric = 0x6c,
              sprGirder = 0x6d,
              sprSpeechCorner = 0x6e,
              sprSpeechEdge = 0x6f,
              sprSpeechTail = 0x70,
              sprThoughtCorner = 0x71,
              sprThoughtEdge = 0x72,
              sprThoughtTail = 0x73,
              sprShoutCorner = 0x74,
              sprShoutEdge = 0x75,
              ...
              sprSnowDust = 0x81,
              sprExplosives = 0x82,
              sprExplosivesRoll = 0x83,
              sprAmTeleport = 0x84,
              sprSplash = 0x85,
              sprDroplet = 0x86,
              sprBirdy = 0x87,
              sprHandCake = 0x88,
              sprHandConstruction = 0x89,
              sprHandGrenade = 0x8a,
              sprHandMelon = 0x8b,
              sprHandMortar = 0x8c,
              sprHandSkip = 0x8d,
              sprHandCluster = 0x8e,
              sprHandDynamite = 0x8f,
              sprHandHellish = 0x90,
              sprHandMine = 0x91,
              sprHandSeduction = 0x92,
              sprHandVamp = 0x93,
              sprBigExplosion = 0x94,
              sprSmokeRing = 0x95,
              sprBeeTrace = 0x96,
              sprEgg = 0x97,
              sprTargetBee = 0x98,
              ...
              sprHandSMine = 0xa6,
              sprHammer = 0xa7,
              sprHandResurrector = 0xa8,
              sprCross = 0xa9,
              sprAirDrill = 0xaa,
              sprNapalmBomb = 0xab,
              sprBulletHit = 0xac,
              sprSnowball = 0xad,
              sprHandSnowball = 0xae,
              sprSnow = 0xaf,
              sprSDFlake = 0xb0,
              sprSDWater = 0xb1,
              sprSDCloud = 0xb2,
              ...
              sprHandCreeper = 0xd0,
              sprMinigun = 0xd1,
              sprSliderInverted = 0xd2,
              sprFingerBack = 0xd3,
              sprFingerBackInv = 0xd4,
              sprTargetPBack = 0xd5,
              sprTargetPBackInv = 0xd6,
              sprHealthHud = 0xd7,
              sprHealthPoisonHud = 0xd8,
              sprVampHud = 0xd9,
              sprKarmaHud = 0xda,
              sprMedicHud = 0xdb,
              sprMedicPoisonHud = 0xdc,
              sprHaloHud = 0xdd,
              sprInvulnHUD = 0xde,
              sprAmPiano = 0xdf,
              sprHandLandGun = 0xe0,
              sprFirePunch = 0xe1,
              sprThroughWrap = 0xe2,
              sprDynamiteDefused = 0xe3,
              sprHogBubble = 0xe4,
              sprHappy = 0xe5,
              sprSentry = 0xe6,
              sprHandSentry = 0xe7} TSprite;
