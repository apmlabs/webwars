...
- **Last Action**: Admin panel filters (show bots, players only), systemd service, README rewrite
...
| C | Admin Panel | ✅ COMPLETE | Flask + Leaflet dashboard, bot detection, geo map |
| C | Dev Server Security | ✅ COMPLETE | nginx reverse proxy, HTTPS + basic auth |
